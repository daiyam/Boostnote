  ...
  submenu: [
    {
      ...
      click () {
        mainWindow.webContents.send('editor:generate-consumption')
      }
    },
     {
      label: 'Generate reserve report',
    ...
    },
    {
      ...
      click () {
        mainWindow.webContents.send('list:show-remaining')
      }
    },
    {
      type: 'separator'
    },
    {
      ...
      click () {
        mainWindow.webContents.send('note:show-consumption')
      }
    },
    {
      label: 'Update mix',
      ...
      click () {
        mainWindow.webContents.send('note:update-mix')
      }
    },
    {
      label: 'Update remaining',
      accelerator: 'Ctrl+Shift+R',
      click () {
        mainWindow.webContents.send('note:update-remaining')
      }
    }
  ]
}
